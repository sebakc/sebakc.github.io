...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\n* {\n\tfont-family: 'Lato', sans-serif;\n\t-webkit-tap-highlight-color: rgba(0,0,0,0);\n}\n.hide {\n\tdisplay: none !important\n}\n.extended {\n\tdisplay: none;\n\twidth: 100%;\n\theight: 100%;\n\ttop: 0;\n}\n.extended.on {\n\tposition:  absolute;\n\tdisplay: block;\n}\n.description {\n\twidth:  200px;\n\theight: 200px;\n\tdisplay: inline-block;\n\tbackground-color: red;\n\t-webkit-transform: scaleY(0);\n\t        transform: scaleY(0);\n\t-webkit-transform-origin: center top !important;\n\t        transform-origin: center top !important;\n\t-webkit-transition: ease-in-out all 1s;\n\ttransition: ease-in-out all 1s;\n\tbackground: transparent;\n\tcolor: transparent;\n\tbottom: 0px\n}\n.description.on {\n\tbackground: black;\n\tcolor: white;\n\t-webkit-animation: fadein ease-in-out 1s forwards;\n\t        animation: fadein ease-in-out 1s forwards;\n}\n.circle-container-father {\n\tdisplay: block;\n}\n@-webkit-keyframes fadein {\n\t0% {\n\t\topacity: 0;\n\t\t-webkit-transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\t        transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\tcolor:black !important;\n\t}\n\t50% {\n\t\topacity: .75;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t}\n\t100% {\n\t\topacity: 1;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(1);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(1);\n\t}\n}\n@keyframes fadein {\n\t0% {\n\t\topacity: 0;\n\t\t-webkit-transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\t        transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\tcolor:black !important;\n\t}\n\t50% {\n\t\topacity: .75;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t}\n\t100% {\n\t\topacity: 1;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(1);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(1);\n\t}\n}\n@-webkit-keyframes fadeout {\n\t0% {\n\t\topacity: 1;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(1);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(1);\n\t}\n\t50% {\n\t\topacity: .75;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t}\n\t100% {\n\t\topacity: 0;\n\t\t-webkit-transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\t        transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\tcolor:black !important;\n\t}\t\n}\n@keyframes fadeout {\n\t0% {\n\t\topacity: 1;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(1);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(1);\n\t}\n\t50% {\n\t\topacity: .75;\n\t\t-webkit-transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t\t        transform: translateX(0px) scaleX(1) scaleY(0.05);\n\t}\n\t100% {\n\t\topacity: 0;\n\t\t-webkit-transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\t        transform: translateX(-400px) scaleX(0) scaleY(0.01);\n\t\tcolor:black !important;\n\t}\t\n}\n@-webkit-keyframes pulse {\n\t0% {\n\t\t-webkit-filter: drop-shadow(2px 8px 1px gray);\n\t\t        filter: drop-shadow(2px 8px 1px gray);\n\t}\n\t60% {\n\t\t-webkit-filter: drop-shadow(2px 8px 2px black);\n\t\t        filter: drop-shadow(2px 8px 2px black);\n\t}\n\t100% {\n\t\t-webkit-filter: drop-shadow(2px 8px 1.5px gray);\n\t\t        filter: drop-shadow(2px 8px 1.5px gray);\n\t}\n}\n@keyframes pulse {\n\t0% {\n\t\t-webkit-filter: drop-shadow(2px 8px 1px gray);\n\t\t        filter: drop-shadow(2px 8px 1px gray);\n\t}\n\t60% {\n\t\t-webkit-filter: drop-shadow(2px 8px 2px black);\n\t\t        filter: drop-shadow(2px 8px 2px black);\n\t}\n\t100% {\n\t\t-webkit-filter: drop-shadow(2px 8px 1.5px gray);\n\t\t        filter: drop-shadow(2px 8px 1.5px gray);\n\t}\n}\n.description.off {\n\tbackground: black;\n\tcolor: black !important;\n\t-webkit-animation: fadeout ease-in-out 1s forwards;\n\t        animation: fadeout ease-in-out 1s forwards;\n}\n.pulse {\n\tfont-weight: bold;\n\t-webkit-animation: pulse ease-in-out 1s infinite;\n\t        animation: pulse ease-in-out 1s infinite;\n}", ""]);
